...
const descricao = document.getElementById("ireview");
const tipoconteudo = document.getElementById ("iconteudo");
const foto = document.getElementById ("foto");
const botaocadastrar = document.getElementById("btn1");
                        ...
                        dados.push(
                                      {
                                        ...
                                        tipoconteudo : tipoconteudo.value,
                                        foto: nomeArq,
                                        email: emaillogado
                                        }
                                     )
                        localStorage.setItem("catalogo", JSON.stringify(dados));
                        window.location.assign("http://127.0.0.1:5501/minhalista.html");
...
function salvaEdicao(pfoto){
  ...
  dados[pindice].tipoconteudo = tipoconteudo.value;
